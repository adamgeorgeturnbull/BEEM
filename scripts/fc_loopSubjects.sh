...
sed -e s:subjectID:"${subjectID}":g -e s:timepoint:${timepoint}:g </scratch/tbaran2_lab/BEEM/scripts/generate_fc_matrix.py >generate_fc_matrix_${subjectID}_${timepoint}.py
