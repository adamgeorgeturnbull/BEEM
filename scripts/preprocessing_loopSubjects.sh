...
sed -e s:subjectID:"${subjectID}":g -e s:timepoint:${timepoint}:g </scratch/tbaran2_lab/BEEM/scripts/preprocessing_singlesubj_3dTproject.sh >preprocessing_${subjectID}_${timepoint}.sh
